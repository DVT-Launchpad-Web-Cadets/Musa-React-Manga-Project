...
export interface ComicState {
  ...
  topManhwa: (MangaDetails | undefined)[] | null;
  topManhua: (MangaDetails | undefined)[] | null;
  ...
  setTopManhwa: (manhwa: (MangaDetails | undefined)[]) => void;
  setTopManhua: (manhua: (MangaDetails | undefined)[]) => void;
